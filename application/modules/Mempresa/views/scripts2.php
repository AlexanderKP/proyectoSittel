...
<!-- Mantenimiento -->
<script type="text/javascript" src="<?=base_url('assets')?>/mantenimiento/cargo/registrar.js"></script>
<script type="text/javascript" src="<?=base_url('assets')?>/mantenimiento/cargo/listar.js"></script>