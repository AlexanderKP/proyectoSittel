<!-- Jquery Core Js -->
    ...
    <!-- Char Js -->
    <script src="<?=base_url('assets')?>/js/char/char.bundle.js"></script>
    <script src="<?=base_url('assets')?>/js/char/char.js"></script>
    <script src="<?=base_url('assets')?>/js/char/mychar.js"></script>