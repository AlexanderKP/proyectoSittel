    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="button" id="btn-cerrarActividad" class="btn btn-primary" data-dismiss="modal">Cerrar</button>
                <button style="display: none;" id="actividadCancelarRsp" type="button" class="btn btn-default" >Cancelar</button>
                <button style="display: none;" id="actividadEnviarRsp" class="btn btn-info">Enviar</button>
            </div>
        </div>
    </div>
</div>